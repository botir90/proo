...
const navItems = [
  ...
  { href: '/homework', label: 'Vazifalar', icon: ClipboardList, roles: ['TEACHER', 'STUDENT'] },
  { href: '/quiz', label: 'Testlar', icon: Trophy, roles: ['TEACHER', 'STUDENT'] },
  ...
  { href: '/rating',        label: 'Reyting',          icon: Trophy, roles: ['TEACHER', 'STUDENT'] },
